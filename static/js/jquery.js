      ...
      Expr = Sizzle.selectors = {
          ...
          ATTR(name, operator, check) {
            return function (elem) {
              ...
              return operator === '='
                ...
                : operator === '*='
                ? check && result.includes(check)
                : operator === '$='
                ? check && result.slice(-check.length) === check
                : operator === '~='
                ? (' ' + result.replace(rwhitespace, ' ') + ' ').includes(check)
                : operator === '|='
                ? result === check ||
        ...
        pseudos: {
          ...
          contains: markFunction(function (text) {
            ...
            return function (elem) {
              return (elem.textContent || getText(elem)).includes(text)
            }
          }),
